...
public class PieceRenderer {
    ...
    private Color faceHighlightColor = Color.YELLOW.darker();
    ...
    public void paint( int x, int y, boolean highlighted, Tile tile, Graphics2D g2 ) {
        ...
        g2.setColor(( highlighted ) ? faceHighlightColor : faceFillColor);
        g2.fill(face);
