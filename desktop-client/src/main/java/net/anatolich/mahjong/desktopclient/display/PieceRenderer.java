...
/**
 * Renders piece and provides information about piece interaction area and clipping path.
 *
...
public class PieceRenderer {
	...
	/**
	 * Provides default clipping path for piece that have no neighbours.
	 * Clipping path must be furthers processed taking into account pieces that are
	 * neighbours of currently rendered one.
	 *
	 * Clipping path is created for piece that is situated at (0,0) coordinates. It should be
	 * translated in order to use on board.
	...
	/**
	 * Paints shape of piece.
	 * Shape is painted in (0,0) coordinates and needs to be translated to it's real position.
	...
	/**
	 * Returns rectangle that encloses clickable area of piece.
	 * Following code detects whether piece was clicked or no:
	 * <pre>
	 *     <code>
